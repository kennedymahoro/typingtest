      ...
      <div className="px-24">
        <div className="p-3.5">
          ...
          <p className="p-4">
            ...
            working on. Slow typing and fixing typing errors moves your
            attention away from what you are trying to achieve (writing an
            email, filling in a form, etc.). Use this advanced typing test to
            discover how well you type. We have test material in more than 15
            languages.
          </p>
        </div>
        <div className="justify-items-center p-3.5">
